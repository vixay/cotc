# Claude Code Instructions - Part 1: Overview & HTML

## Project Overview
Create a community-maintained guide for Octopath Traveler: Champions of the Continent (COTC) awakening stone priorities using GitHub Pages.
...
├── data/
│   ├── characters.json    # Character data (main data file)
│   └── schema.json        # Data structure documentation
├── js/
│   ├── app.js            # Main application logic
│   └── filters.js        # Filtering/sorting functions
├── css/
│   └── style.css         # Styling
├── docs/
│   ├── CONTRIBUTING.md   # How to contribute
│   ├── DATA_FORMAT.md    # Data format explanation
...
└── .github/
    ...
    │   └── bug-report.md
    └── workflows/
        └── validate-data.yml  # Auto-validate PRs
```
...
<head>
    ...
    <title>COTC Awakening Stone Priority Guide</title>
    <meta name="description" content="Community-maintained guide for Octopath Traveler: Champions of the Continent awakening stone priorities">
    ...
    <div class="container">
        ...
        <div class="table-container">
            <table id="characterTable">
                <thead>
                    <tr>
                        <th data-sort="name" class="sortable">Character <span class="sort-indicator"></span></th>
                        <th data-sort="a4Tier" class="sortable">A4 Tier <span class="sort-indicator"></span></th>
                        <th data-sort="ultPriority" class="sortable">Ult Priority <span class="sort-indicator"></span></th>
                        <th>AS1</th>
                        <th>AS2</th>
                        <th>AS3</th>
                        <th>AS4</th>
                ...
                <tbody id="tableBody">
                    <tr>
                        <td colspan="9" class="loading">Loading character data...</td>
                    </tr>
                </tbody>
            </table>
        </div>
...
## Next Steps
- Part 2 will contain: Character data JSON (split into chunks)
- Part 3 will contain: CSS styles
- Part 4 will contain: JavaScript files
- Part 5 will contain: Documentation files
- Part 6 will contain: GitHub templates and workflows